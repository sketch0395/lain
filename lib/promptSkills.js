...
const SKILLS = [
  ...
  { key: "cve_lookup", text: CVE_LOOKUP_SKILL, category: "cyber_intel" },
  {
    key: "ip_reputation",
...
export function buildSkillsPromptAddendum(userText, flags = {}) {
  ...
  for (const skill of SKILLS) {
    ...
    // added up fast across unrelated conversations.
    const categoryOk = !skill.category || Boolean(categories && categories.has(skill.category));
