...
export const LAPTOP_TOOL_DEFINITIONS = [
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Check whether a newer version of Lain is available in the git repo " +
        "(fetches from the remote and compares against the current commit). " +
