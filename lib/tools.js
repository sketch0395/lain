  ...
  },
  {
    ...
    function: {
      ...
      description:
        ...
        "via read_file if unsure of the exact keys), optionally downloads a " +
        "background image from a URL into the theme's backgrounds/ folder, " +
        "and optionally applies the new theme immediately.",
      parameters: {
        type: "object",
        properties: {
          name: {
          ...
          background_url: {
            type: "string",
            description: "Optional URL of a background image to download into the theme.",
          },
          apply: {
            type: "boolean",
