  ...
  },
  {
    ...
    function: {
      ...
      description:
        ...
        "right now'. The capture is always saved as a .pcap file (to " +
        "~/Documents/pcaps/ by default, or save_path if given) so it's never " +
        "lost — pass no_save: true only if the user explicitly doesn't want it " +
        "kept. Requires the tools agent's tcpdump to have packet-capture " +
