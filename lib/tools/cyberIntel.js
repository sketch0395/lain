...
export const CATEGORY_KEYWORDS = [
  ...
  "playbook", "runbook", "incident response", "ir plan", "response plan",
  "incident playbook", "security incident", "we've been breached",
  "we have been breached", "suspected compromise", "account compromise",
  "data exfiltration", "malware infection", "phishing report",
  "incident report", "write up the report", "after action report",
  "write the report", "generate the report", "incident report history",
  "abuseipdb", "urlhaus", "ip reputation", "abusive ip", "malicious ip",
  "check this ip", "is this ip safe", "nvd", "national vulnerability database",
  "file hash", "check this hash", "file reputation", "malware sample",
  "cwe", "cvss",
];
