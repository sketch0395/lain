...
import { virusTotalConfigured, checkUrlLegitimacy } from "../urlProvenance";
...
export function getDefinitions() {
  ...
  // check_url_legitimacy needs a VIRUSTOTAL_API_KEY to be useful (VirusTotal
  // is the strongest signal it produces) — gated the same way network.js
  // gates the Shodan tools on shodanConfigured().
